...
// ── Drop-in replacement. Path in project: components/layout/Sidebar.tsx ──
'use client'
...
/* ── Logo wordmark (shared) ── */
function FiduciaryLogo() {
  return (
    <Link href="/dashboard" className="flex items-center gap-2.5 group">
      ...
      <span className="font-display font-bold text-primary-800 text-lg tracking-tight">
        Fiduciary
      </span>
    </Link>
  )
          ...
          >
            <span
              className={cn(
                ...
                isActive ? 'text-gold-600' : 'text-gray-400 group-hover:text-primary-600'
              )}
            >
              {item.icon}
            </span>
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  {userProfile?.profilePhoto ? (
                    <img
                      ...
                      alt="Profile"
                      className="w-10 h-10 rounded-full object-cover border-2 border-gold-200"
                    />
                  ) : (
                    <div className="w-10 h-10 rounded-full bg-primary-100 border-2 border-gold-200
              ...
              <div className="px-5 py-4 border-t border-gray-100">
                <form action="/api/auth/signout" method="POST">
                  <button
                    type="submit"
                    className="flex items-center gap-2 text-sm text-gray-500 hover:text-danger-600 transition-colors"
                  >
          ...
          <div className="px-5 py-4 border-b border-gray-100">
            <div className="flex items-center gap-3">
              {userProfile?.profilePhoto ? (
                ...
                <div className="w-10 h-10 rounded-full bg-primary-50 border-2 border-gold-200
                                flex items-center justify-center">
                  <span className="text-primary-800 font-bold text-sm">
                    {userProfile?.firstName?.[0]}{userProfile?.lastName?.[0]}
                  </span>
